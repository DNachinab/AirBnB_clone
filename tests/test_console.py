...
"""Unittests to check the HBNB command interpreter's prompting"""
...
"""Unittests to test the HBNB command interpreter's help messages"""
class TestHBNBCommand_help(unittest.TestCase):
    
    def test_help_quit(self):
        h = "Quit command and exit the program."
        with patch("sys.stdout", new=StringIO()) as output:
